...
<body>
    ...
    <div class="button-container">
        <a href="main"><button class="button">Top</button></a>
        <a href="main"><button class="button">Adc</button></a>
        <a href="main"><button class="button">Mid</button></a>
        <a href="main"><button class="button">Jungle</button></a>
        <a href="main"><button class="button">Support</button></a>
    </div>
