<div class="fixed w-screen min-h-screen text-white font-mono flex flex-col items-center justify-center" style="background-image: url('tloMid.jpg'); background-size: cover; background-position: center;">
