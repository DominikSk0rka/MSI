...
<div class="fixed bg-black w-screen min-h-screen text-white font-mono flex flex-col items-center justify-center ">
    @if($show==false)
    <div class="container" >        
            <button wire:click="setLaneIndex('Top')">Top</button>  
            <button wire:click="setLaneIndex('Mid')">Mid</button>  
            <button wire:click="setLaneIndex('Jungle')">Jungle</button>  
            <button wire:click="setLaneIndex('Adc')">Adc</button>  
            <button wire:click="setLaneIndex('Support')">Support</button>          
